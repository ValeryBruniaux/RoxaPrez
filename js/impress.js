...
( function( document, window ) {
    ...
    var preInit = function() {
        if ( window.markdownit ) {
            ...
            var md = window.markdownit("default", { html: true, breaks: true, linkify: true, typographer: true } ).use(markdownitSub).use(markdownitSup).use(markdownitTaskLists).use(markdownitEmoji).use(markdownitMark).use(markdownitContainer, "warning");
